...
df_prediction_proba.columns = ["Negative diagnosis probability", "Positive diagnosis probability"]
df_prediction_proba.rename(columns={0: 'Negative diagnosis probability',
                                   1: 'Positive diagnosis probability'})
...
st.dataframe(df_prediction_proba,
            column_config={
              'Negative diagnosis probability': st.column_config.ProgressColumn(
                'Negative diagnosis probability',
                format='%f',
                width='medium',
                min_value=0,
                max_value=1
              ),
              'Positive diagnosis probability': st.column_config.ProgressColumn(
                'Positive diagnosis probability',
                format='%f',
                width='medium',
                min_value=0,
                max_value=1
...
#df_prediction_proba
patient_diagnosis = np.array(['Low risk of heart disease', 'High risk of heart disease: Referral for further testing is recommended!'])
